        ...
        <SafeAreaView >
            <View className="h-screen bg-gray-50 flex justify-center relative">
                ...
                <View className="px-8">
                    ...
                    <TouchableOpacity onPress={() => toogleLanguage()} className={`mt-7 bg-gray-100 px-5 py-4 rounded ${lang === 'ar' && 'border border-red-500'}`}>
                    ...
                    <TouchableOpacity onPress={() => toogleLanguage()} className={`mt-7 bg-gray-100 px-5 py-4 rounded ${lang === 'eng' && 'border border-red-500'}`}>
